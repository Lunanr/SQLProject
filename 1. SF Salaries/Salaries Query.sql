...
-- 10 Show all employeess with a job title not equal to "Manager".
select EmployeeName, JobTitle from salaries
where JobTitle <> 'Manager';

-- 11 Show all employeess with a total pay between 50,000 and 75,000.
...
-- 15 Show all job titles with an average basepay of
...
-- 18 Delete all employeess who have no OvertimePay
select count(*) from salaries
where OvertimePay = 0;
